...
import { MCPLibraryInstallSheet } from "./views/mcpLibraryInstallSheet";
		...
		<div className="mx-auto w-full max-w-7xl space-y-6">
			...
			<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
				{MCP_LIBRARY_SERVERS.map((server) => {
					...
					return (
						<Card key={server.slug} className="min-h-64 gap-4" data-testid={`mcp-library-card-${server.slug}`}>
							...
							<CardContent className="flex flex-1 flex-col gap-3">
								...
								<div className="flex flex-wrap gap-2">
									...
									<Badge variant="outline">{authTypeLabels[server.defaultAuthType]} suggested</Badge>
								</div>
							</CardContent>
