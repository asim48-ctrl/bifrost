...
Read `RegisterAPIRoutes` and `RegisterInferenceRoutes` carefully:

```bash
sed -n '1060,1186p' transports/bifrost-http/server/server.go
sed -n '1380,1495p' transports/bifrost-http/server/server.go
```
...
Read the auth and middleware setup:

```bash
sed -n '1380,1495p' transports/bifrost-http/server/server.go
sed -n '720,920p' transports/bifrost-http/handlers/middlewares.go
sed -n '920,1040p' transports/bifrost-http/handlers/middlewares.go
```
...
```bash
sed -n '300,360p' transports/bifrost-http/lib/ctx.go
sed -n '1,90p' plugins/governance/utils.go
sed -n '3920,3965p' transports/bifrost-http/handlers/governance.go
```
